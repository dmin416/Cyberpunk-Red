...
const itemsDatabase = [
  ...
  // MORE RANGED WEAPONS
  {
    ...
    hands: 1,
    concealable: "J",
    description: "Standard medium-sized handgun firing 9mm equivalent rounds. Holds 12 bullets. Reliable sidearm for edgerunners. Uses Handgun skill.",
  ...
  },
  {
    ...
    hands: 1,
    concealable: "J",
    description: "Heavy-caliber handgun with serious stopping power. Holds 8 bullets. Can be concealed. Uses Handgun skill.",
    tags: ["ranged", "firearm", "pistol", "heavy"],
    availability: "Common"
  },
  {
    id: 170,
    ...
    hands: 2,
    concealable: "L",
    description: "Submachine gun with autofire capability. 30-round magazine. Uses Autofire skill: 10 rounds per attack, multiply damage by amount DV beaten by (max 3). Uses Shoulder Arms skill.",
    tags: ["ranged", "firearm", "smg", "autofire"],
    availability: "Common"
  },
  {
    id: 171,
    ...
    hands: 2,
    concealable: "L",
    description: "Heavy submachine gun with 40-round magazine. Autofire capable: 10 rounds per attack, multiply damage by amount DV beaten by (max 3). More capacity than standard SMG. Uses Shoulder Arms skill.",
    tags: ["ranged", "firearm", "smg", "autofire", "heavy"],
    availability: "Common"
  },
  {
    id: 172,
    ...
    hands: 2,
    concealable: "N",
    description: "Standard shotgun firing slugs (5d6) or shells (3d6 to all in 6m radius on DV13). Cannot make Aimed Shots with shells. Devastating close-range weapon. Uses Shoulder Arms skill.",
    tags: ["ranged", "firearm", "shotgun"],
    availability: "Expensive"
  },
  {
    id: 173,
    ...
    hands: 2,
    concealable: "N",
    description: "Standard military assault rifle. 25-round magazine. Autofire capable (Autofire 4) and Suppressive Fire. 800m range. Uses Shoulder Arms skill.",
    tags: ["ranged", "firearm", "assault-rifle", "autofire", "military"],
    availability: "Expensive"
  },
  {
    id: 174,
    ...
    hands: 2,
    concealable: "N",
    description: "Long-range precision rifle. 4-round magazine. Specializes in hitting targets from far away. Excellent for stealth operations. Uses Shoulder Arms skill.",
    tags: ["ranged", "firearm", "sniper", "precision"],
    availability: "Expensive"
  },
  {
    id: 175,
    ...
    hands: 2,
    concealable: "N",
    description: "Launches grenades at range. Can fire any grenade type. Uses Heavy Weapons skill. Damage depends on grenade type loaded.",
    tags: ["ranged", "explosive", "launcher", "heavy"],
    availability: "Expensive"
  },
  {
    id: 176,
    name: "Rocket Launcher",
    category: "Weapons",
    subcategory: "Rocket Launchers",
    cost: 1000,
    damage: "8d6",
    rof: 1,
    hands: 2,
    concealable: "N",
    description: "Heavy anti-vehicle rocket launcher. Devastating explosive weapon. Single shot requires reload. Uses Heavy Weapons skill. Extremely dangerous.",
    tags: ["ranged", "explosive", "launcher", "heavy", "anti-vehicle"],
    availability: "Expensive"
  },
  ...
  // NETRUNNER GEAR
  {
    ...
    category: "Gear",
    subcategory: "Netrunning",
    cost: 100,
    description: "Poor Quality Cyberdeck with 5 program slots. Basic netrunning equipment. Requires Interface Plugs and Neural Link to operate. Used to access the NET Architecture.",
    tags: ["netrunning", "tech", "cyberdeck", "poor-quality"],
    availability: "Common"
  },
  {
    id: 178,
    ...
    subcategory: "Netrunning",
    cost: 500,
    description: "Standard Quality Cyberdeck with 7 program slots. Professional netrunning equipment. Requires Interface Plugs and Neural Link to operate. Most common choice for Netrunners.",
    tags: ["netrunning", "tech", "cyberdeck", "standard-quality"],
    availability: "Expensive"
  },
  {
    id: 179,
