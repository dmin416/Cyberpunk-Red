...
|-----|-----|-----|------|------|------|------|------|-----|------|
| 4 | 4 | 8 | 8 | 4 | 8 | 8 | 12 | 1 | 6 |

| HP | SW | Death Save | Init | Humanity | Sanity (Hare) |
|----|----|------------|------|----------|---------------|
...
| Weapon | Skill Base | ROF | DMG | Notes |
|--------|------------|-----|-----|-------|
| CA Thermal Dagger | **16** | 2 | 2d6 | 1H · Conceal |
| EQ Rippers | **16** | 2 | 2d6 | 1H · Conceal · chrome |
| EQ Wolverine Metalstar | **16** | 2 | 2d6 | 1H · Conceal · chrome |
| Mono Wakizashi | **15** | 2 | 3d6 | 1H |
| Sledgehammer | **15** | 2 | 4d6 | 2H · No conceal |
...
| Armor | Type | SP | Ablated |
|-------|------|----|---------|
| Head | Subdermal | **11** | 0 |
| Body | Light Armorjack | **10** | 1 |

**Evasion base 15** (can dodge ranged). Melee / MA ignore **half** SP. Ranged / Brawl ignore **none**.
